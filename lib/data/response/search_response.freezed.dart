...
mixin _$SearchResponse {
  ...
  /// 検索結果
  List<Address>? get results => throw _privateConstructorUsedError;
...
abstract class $SearchResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int status, List<Address>? results, String? message});
}
...
class _$SearchResponseImpl implements _SearchResponse {
  const _$SearchResponseImpl(
      ...
      required final List<Address>? results,
  ...
  /// 検索結果
  final List<Address>? _results;

  /// 検索結果
  @override
  List<Address>? get results {
  ...
  @override
  String toString() {
    return 'SearchResponse(status: $status, results: $results, message: $message)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status,
      const DeepCollectionEquality().hash(_results), message);
...
abstract class _SearchResponse implements SearchResponse {
  const factory _SearchResponse(
      ...
      required final List<Address>? results,
      required final String? message}) = _$SearchResponseImpl;
